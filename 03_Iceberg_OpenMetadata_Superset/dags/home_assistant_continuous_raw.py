...
with DAG(
    ...
    # Iceberg: setup catalog -> write data (after IoT fetch)
    task_setup_iceberg >> task_fetch_iot >> task_write_iceberg
    
    [task_fetch_iot, task_fetch_price, task_fetch_weather, task_create_static_tables, task_write_iceberg] >> task_dbt_debug
